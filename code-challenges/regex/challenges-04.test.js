...
Write a function named citiesAtoJ that takes in an array of string names and uses a regular expression pattern to return a new array containing any cities that begin with the letters A through J, inclusive.
------------------------------------------------------------------------------------------------ */
...
const citiesAtoJ = (arr) => {
  ...
  let output = [];
  arr.forEach(string => {
    regex.test(string) ? output.push(string) : console.log();
  })
  return output;
};
...
Write a function named noPunctuation that contains a regular expression pattern to find all
 of the words that contain a space immediately at the end of the word. Return an array of all 
...
let hangman = (str) => {
  let code = /[a,e,i,o,u]/gi;
  return str.replace(code, '_');
};
...
describe('Testing challenge 3', () => {
  let cities = ['Cleveland', 'San Diego', 'Birmingham', 'Seattle', 'Miami', 'New York string', 'Omaha', 'Portland', 'Austin', 'Boston', 'Newport Beach', 'Hoboken'];
  ...
  test('It should not return the cities whose names begin with the letters K through Z', () => {
    expect(citiesAtoJ(cities)).not.toContain('San Diego', 'Seattle', 'Miami', 'New York string', 'Omaha', 'Portland', 'Newport Beach');
  });
});
